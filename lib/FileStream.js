...
var FileStream = module.exports = function (engine, file, opts) {
	if (this instanceof FileStream === false) return new FileStream(engine, file, opts);
	...
	var pieceLength = engine._torrent.pieceLength;
...
FileStream.prototype.notify = function() {
	...
	if (!this._engine._bitfield.get(this._piece)) return this._engine.critical(this._piece, this._critical);

	var self = this;

	if (this._notifying) return;
	this._notifying = true;
	this._engine._storage.read(this._piece++, function(err, buffer) {
